...
\usepackage{xcolor}
\definecolor{border}{HTML}{51ffd9}

\usepackage{tcolorbox}
\usepackage{etoolbox}
% for angular corners, Argument: arc is angular
\BeforeBeginEnvironment{minted}{\begin{tcolorbox}[colback=white,colframe=border, boxrule=0.3mm]}
...
\renewcommand{\listoflistingscaption}{Programcode}
